...
function App(){
 ...
 const [input, setInput] =  useState('')
    ...
    <li className="listItem">{item.value} <button className="del-btn" onClick={()=> removeItem(item.key)}>Delete</button>
    </li>)
return (
        ...
        <div className=" col-lg-6 main-section">
            <div className="row section-header">
                ...
                <div className="row section-input">
                    ...
                    <button onClick={pushItem} className="add-btn"> Add </button>
                 </div>
